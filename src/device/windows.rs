...
pub mod config {
    ...
    const AVAILABLE_KEYS: [(&str, MappedKey); 95] = [
        ...
        ("KEY_PAUSE", MappedKey::KEY_PAUSE),
        ("KEY_NUMERIC_0", MappedKey::KEY_NUMERIC_0),
        ("KEY_NUMERIC_1", MappedKey::KEY_NUMERIC_1),
        ("KEY_NUMERIC_2", MappedKey::KEY_NUMERIC_2),
        ("KEY_NUMERIC_3", MappedKey::KEY_NUMERIC_3),
        ("KEY_NUMERIC_4", MappedKey::KEY_NUMERIC_4),
        ("KEY_NUMERIC_5", MappedKey::KEY_NUMERIC_5),
        ("KEY_NUMERIC_6", MappedKey::KEY_NUMERIC_6),
        ("KEY_NUMERIC_7", MappedKey::KEY_NUMERIC_7),
        ("KEY_NUMERIC_8", MappedKey::KEY_NUMERIC_8),
        ("KEY_NUMERIC_9", MappedKey::KEY_NUMERIC_9),
    ];
